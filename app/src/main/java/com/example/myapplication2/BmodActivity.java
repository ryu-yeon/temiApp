...
import com.example.myapplication2.VideoActivity;
...
public class BmodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TtsRequest ttsRequest = TtsRequest.create("아이방으로 이동합니다", true);
        robot.speak(ttsRequest);
        robot.goTo("아기방"); //아기방으로 이동
        ...
        video_p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BmodActivity.this, VideoActivity.class);
        ...
        btn_b2h.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BmodActivity.this, MainActivity.class);
        ...
        music_p.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(BmodActivity.this,R.raw.music);
                mediaPlayer.start();
            }
        });
        ...
        databaseReference.child("stop_video2").addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                Intent intent = new Intent(BmodActivity.this, BmodActivity2.class);
                startActivity(intent);
                finish();
